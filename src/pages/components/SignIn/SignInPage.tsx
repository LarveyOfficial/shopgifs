      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <div className="flex-auto space-y-3">
          <button
            onClick={() =>
              signIn("google", {
                callbackUrl: `${globalThis.location.origin}/panel/home`,
              })
            }
          ...
          <Link
            href="/"
            className="text-dark flex w-full justify-center rounded-md bg-blue-500 px-3 py-1.5 text-sm font-semibold leading-6 shadow-sm hover:bg-blue-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
          >
            <span>Go to GIF Player</span>
          </Link>
        </div>
      </div>
    </div>
